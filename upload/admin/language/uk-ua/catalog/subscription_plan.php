...
// Help
$_['help_trial_duration']   = 'Кількість разів, скільки покупець має здійснити платіж';
$_['help_trial_cycle']      = 'Вартість підписки розраховується за періодичністю та циклами';
...
$_['help_duration']         = 'Тривалість – це кількість разів, скільки покупець має здійснити платіж. Встановіть значення 0, якщо ви хочете здійснювати платежі, доки їх не буде скасовано';
